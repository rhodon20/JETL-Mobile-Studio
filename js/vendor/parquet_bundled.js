var JETLParquet = (() => {
  ...
  // js/vendor/parquet-bridge.js
  var parquet_bridge_exports = {};
  __export(parquet_bridge_exports, {
    init: () => init,
    parseParquetToJSON: () => parseParquetToJSON,
    writeJSONToParquet: () => writeJSONToParquet
  });
...
${val.stack}`;
  ...
  var ColumnChunkMetaDataFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_columnchunkmetadata_free(ptr >>> 0, 1));
  var ColumnChunkMetaData = class _ColumnChunkMetaData {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  var FFIDataFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_ffidata_free(ptr >>> 0, 1));
  var FFIData = class _FFIData {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  var FFISchemaFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_ffischema_free(ptr >>> 0, 1));
  var FFISchema = class _FFISchema {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  var FFIStreamFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_ffistream_free(ptr >>> 0, 1));
  var FFIStream = class _FFIStream {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  var FileMetaDataFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_filemetadata_free(ptr >>> 0, 1));
  var FileMetaData = class _FileMetaData {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  var ParquetFileFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_parquetfile_free(ptr >>> 0, 1));
  var ParquetFile = class _ParquetFile {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  var ParquetMetaDataFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_parquetmetadata_free(ptr >>> 0, 1));
  var ParquetMetaData = class _ParquetMetaData {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  var RecordBatchFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  ...
  var RowGroupMetaDataFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_rowgroupmetadata_free(ptr >>> 0, 1));
  var RowGroupMetaData = class _RowGroupMetaData {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  var WriterPropertiesFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_writerproperties_free(ptr >>> 0, 1));
  var WriterProperties = class _WriterProperties {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  var WriterPropertiesBuilderFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
  }, unregister: () => {
  } } : new FinalizationRegistry((ptr) => wasm.__wbg_writerpropertiesbuilder_free(ptr >>> 0, 1));
  var WriterPropertiesBuilder = class _WriterPropertiesBuilder {
    static __wrap(ptr) {
      ptr = ptr >>> 0;
  ...
  async function __wbg_load(module, imports) {
    if (typeof Response === "function" && module instanceof Response) {
      ...
      const instance8 = await WebAssembly.instantiate(module, imports);
      if (instance8 instanceof WebAssembly.Instance) {
        return { instance: instance8, module };
      } else {
        return instance8;
      }
    }
  ...
  function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_new_2e3c58a15f39f5f9 = function(arg0, arg1) {
      try {
        ...
        var cb0 = (arg02, arg12) => {
          ...
          state0.a = 0;
          try {
            return __wbg_adapter_268(a, state0.b, arg02, arg12);
          } finally {
            state0.a = a;
          }
        };
    ...
    imports.wbg.__wbg_new_99a6a948d5b3f607 = function() {
      return handleError(function() {
    ...
    imports.wbg.__wbg_slice_224856d46230c13c = function() {
      return handleError(function(arg0, arg1, arg2) {
  ...
  function __wbg_finalize_init(instance8, module) {
  ...
  async function __wbg_init(module_or_path) {
    ...
    const { instance: instance8, module } = await __wbg_load(await module_or_path, imports);
    return __wbg_finalize_init(instance8, module);
  }
  var parquet_wasm_default = __wbg_init;
  ...
  function makeVector(init2) {
    if (init2) {
      ...
      if (ArrayBuffer.isView(init2)) {
        ...
        const props = { offset: 0, length: init2.length, nullCount: -1, data: init2 };
...
return true;`);
  ...
  var Footer_ = class {
    ...
    static decode(buf) {
      ...
      const schema = Schema3.decode(footer.schema(), /* @__PURE__ */ new Map(), footer.version());
  ...
  function decodeMessageHeader(message, type) {
    return (() => {
      switch (type) {
        case MessageHeader.Schema:
          return Schema3.decode(message.header(new Schema2()), /* @__PURE__ */ new Map(), message.version());
        case MessageHeader.RecordBatch:
  ...
  function tableFromJSON(array) {
    ...
    const batch = new RecordBatch4(new Schema3(vector.type.children), vector.data[0]);
    return new Table2(batch);
  }
  ...
  var Table2 = class _Table {
    constructor(...args) {
      ...
      const unwrap = (x) => {
        if (x) {
          if (x instanceof RecordBatch4) {
            ...
            const batchSchema = schema !== null && schema !== void 0 ? schema : new Schema3(keys.map((k, i) => new Field2(String(k), vecs[i].type, vecs[i].nullable)));
      ...
      schema = (_c2 = schema !== null && schema !== void 0 ? schema : (_b2 = batches[0]) === null || _b2 === void 0 ? void 0 : _b2.schema) !== null && _c2 !== void 0 ? _c2 : new Schema3([]);
  ...
  var _InternalEmptyPlaceholderRecordBatch = class extends RecordBatch4 {
    constructor(schema) {
    ...
    _loadDictionaryBatch(header, body) {
      ...
      if (header.data.compression != null) {
        ...
        if ((codec === null || codec === void 0 ? void 0 : codec.decode) && typeof codec.decode === "function") {
          ...
          header = new DictionaryBatch2(new RecordBatch3(header.data.length, header.data.nodes, buffers, null), id, isDelta);
        } else {
  ...
  // js/vendor/parquet-bridge.js
  async function init(wasmUrl = "https://unpkg.com/parquet-wasm@0.6.1/esm/parquet_wasm_bg.wasm") {
    await parquet_wasm_default(wasmUrl);
  }
  function parseParquetToJSON(buffer) {
    const ipc = readParquet(new Uint8Array(buffer));
    const table = tableFromIPC(ipc);
    return table.toArray().map((row) => row.toJSON());
  }
  function writeJSONToParquet(rows) {
    const table = tableFromJSON(rows);
    const ipc = tableToIPC(table, "file");
    return writeParquet(ipc);
  }
  return __toCommonJS(parquet_bridge_exports);
})();
