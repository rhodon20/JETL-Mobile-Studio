...
| --- | --- | --- |
| Catálogo objetivo de nodos | 117 Desktop en alcance / 81 IDs compartidos | Cerrar 36 ausencias vectoriales/tabulares y resolver extensiones incompatibles |
...
| Nodo compacto + editor modal estilo Desktop | Attributes completa y cinco transformadores Geometry comparten resumen + JSON + Guardar/Cancelar | Extender el patrón a los transformadores Geometry complejos restantes |
