...
| --- | --- | --- |
| Catálogo objetivo de nodos | 117 Desktop en alcance / 89 IDs compartidos | Cerrar 28 ausencias vectoriales/tabulares y resolver extensiones incompatibles |
...
| Nodo compacto + editor modal estilo Desktop | Attributes y Geometry configurables comparten resumen + JSON + Guardar/Cancelar | Extender el patrón a Readers, Spatial, Utils y Writers |
