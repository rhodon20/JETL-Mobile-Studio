...
Implementado como patrón en **Field Calculator Pro**, **String Formatter**,
**List Concatenator**, **Substring Extractor**, **Attribute Splitter**, **List
Exploder**, **String Replacer**, **Aggregator**, **Attribute Keeper**, **Attribute
Creator multirregla** y **Attribute Manager legado/v2**.
Los editores conservan la configuración en JSON y admiten la apertura
...
exponen el selector nativo directamente dentro del modal y ofrecen feedback
inmediato con el nombre o número de archivos seleccionados. No dependen de abrir
por JavaScript un input oculto, evitando el bloqueo de gestos de iOS. CSV, Excel
y GeoJSON añaden un editor
